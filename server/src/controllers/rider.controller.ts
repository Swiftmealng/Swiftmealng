...
export const updateLocation = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    const rider = await riderService.updateRiderLocation(riderId, location, orderId);
...
export const uploadPhoto = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    const { uploadRiderPhoto, isCloudinaryConfigured } = await import('../config/cloudinary/cloudinary');
